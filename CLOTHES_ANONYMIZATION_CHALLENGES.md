...
Ce document détaille les contraintes techniques rencontrées lors de l'implémentation de l'anonymisation des vêtements dans le projet videoPrivacy c'est pourquoi on a pas l'utiliser, ainsi que les solutions potentielles utilisant des technologies avancées et l'accélération GPU CUDA.
